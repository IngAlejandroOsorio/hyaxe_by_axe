...
namespace DowntownRP_cs.inventory
{
    public class Main : Events.Script
    {
        ...
        public Main()
        {
            ...
            Events.Add("UseItemInv", UseItemInv);
            Events.Add("DropItemInv", DropItemInv);
        }

        private void UseItemInv(object[] args)
        {
            Events.CallRemote("UseItemInventory", (int)args[0]);
        }

        private void DropItemInv(object[] args)
        {
            Events.CallRemote("DropItemInventory", (int)args[0]);
        }
