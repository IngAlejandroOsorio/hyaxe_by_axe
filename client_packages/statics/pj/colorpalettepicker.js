(function ($) {
    ...
    $.fn.colorPalettePicker.defaults = {
        button: '<button name="colorpalettebutton3" class="{buttonClass} btn-primary btn-block" data-toggle="dropdown"><span name="{buttonPreviewName}" style="display:none">■ </span>{buttonText}</button>',
