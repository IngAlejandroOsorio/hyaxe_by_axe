...
namespace DowntownRP.World.Factions.PD
{
    public class Doors : Script
    {
        ...
        public void EnterCS_DoorPolice(ColShape shape, Player player)
        {
            if (shape.HasData("PD_DOOR"))
            {
                player.SetData("PD_DOOR", shape.GetData<string>("PD_DOOR"));
        ...
        public void ExitCS_DoorPolice(ColShape shape, Player player)
        {
            if (shape.HasData("PD_DOOR"))
            {
        ...
        public void PoliceDoorManager(Player player)
        {
            ...
            {
                switch (player.GetData<string>("PD_DOOR"))
                {
                    case "MAIN":
                        sh = player.GetData<ColShape>("PD_DOOR_COL");
                        ...
                        if (sh.GetData<bool>("PD_DOOR_STATUS") == false)
                        {
                        ...
                        if (sh.GetData<bool>("PD_DOOR_STATUS") == true)
                        {
                            NAPI.ClientEvent.TriggerClientEventInDimension(0, "open_door_police");
                            sh.SetData("PD_DOOR_STATUS", false);
                            Utilities.Notifications.SendNotificationOK(player, "Has abierto la puerta");
