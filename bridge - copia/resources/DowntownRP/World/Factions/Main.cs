    ...
    public class Main : Script
    {
        ...
        public async Task CMD_aceptarfaccion(Client player)
        {
            ...
            if (player.HasData("FACTION_PETICION"))
            {
                ...
                await Axe.Creador.Main.UpdateUserFaction(user.idpj, faction);
                await Axe.Creador.Main.UpdateUserFactionRank(user.idpj, 1);
            ...
            if (user.faction != 0)
            {
                if (user.rank == 15)
                {
                    ...
                    if (target != null)
                    {
                        ...
                        await Axe.Creador.Main.UpdateUserFaction(client.idpj, 0);
                        await Axe.Creador.Main.UpdateUserFactionRank(client.idpj, 1);
